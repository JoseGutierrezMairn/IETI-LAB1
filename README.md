...
![create()](https://github.com/JoseGutierrezMairn/IETI-LAB1/blob/main/img/create.PNG?raw=true)   

- Testing get all users request   
![getAll()](https://github.com/JoseGutierrezMairn/IETI-LAB1/blob/main/img/getAll.PNG?raw=true)   

- Testing get user by id request
![getById()](https://github.com/JoseGutierrezMairn/IETI-LAB1/blob/main/img/getById.PNG?raw=true)   

- Testing update user request
![update()](https://github.com/JoseGutierrezMairn/IETI-LAB1/blob/main/img/update.PNG?raw=true)   
    - Api rest response is an error because the user id does not exist
	![update fails](https://github.com/JoseGutierrezMairn/IETI-LAB1/blob/main/img/updateFails.PNG?raw=true)   

- Testing delete user request
![delete()](https://github.com/JoseGutierrezMairn/IETI-LAB1/blob/main/img/delete.PNG?raw=true)   
    - Api rest response is an error because the user id does not exist   
	![delete fails](https://github.com/JoseGutierrezMairn/IETI-LAB1/blob/main/img/deleteFails.PNG?raw=true) 